            ...
            <form method="GET" action="{{ route('compras.index') }}" class="row g-2 align-items-end">
                ...
                <div class="col-md-3">
                    ...
                    <select name="parametro" class="form-select form-select-sm">
                        ...
                        <option value="id_compra" {{ request('parametro')=='id_compra' ? 'selected' : '' }}>Código OC</option>
                        <option value="id_proveedor" {{ request('parametro')=='id_proveedor' ? 'selected' : '' }}>Proveedor</option>
                        ...
                        <td class="text-center">
                            @if($esAbierta)
                                <div class="d-flex justify-content-center gap-1">
                                    <a href="{{ route('compras.edit', $idOc) }}"
                                    ...
                                    <form method="POST" action="{{ route('compras.aprobar', $idOc) }}">
                                        @csrf
                                        <button type="submit"
                                                class="btn btn-sm fw-bold px-3 py-1 shadow-sm"
